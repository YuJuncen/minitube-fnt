...
async function startWork<T>(work: () => Promise<T>, begin: () => () => void) : Promise<T> {
    const end = begin()
...
export default { startWork, useWork, makeLoginKey, useBoundInput, usernameChecker, emailChecker, phoneChecker }